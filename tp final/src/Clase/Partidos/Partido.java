...
public class Partido {
    ...
    public Partido(LocalDate fecha, boolean esLocal, String rival, int golesAFavor, int golesEnContra, int entradasVendidas, double precioEntrada, int capacidadEstadio) throws IllegalArgumentException {
        if (fecha == null) {
        ...
        if (rival == null || rival.isBlank()) {
            throw new IllegalArgumentException("Debe ingresar el nombre del rival");
        }
